...
public class Trainer {
    ...
    public void gradient(List<List<Integer>> pixels, double lr) {
        ...
        List<List<Double>> dw0 = new ArrayList<>(); // jk
        List<Double> b0 = new ArrayList<>(); // j
        List<List<Double>> dw1 = new ArrayList<>(); // jk, calc1 calc2
        List<Double> b1 = new ArrayList<>(); // j, calc2
        List<List<Double>> dw2 = new ArrayList<>(); // jk, calc1 calc2
        List<Double> b2 = new ArrayList<>(); // j, calc2
        ...
        List<List<Double>> weights2 = new ArrayList<>();
        List<Double> biases2 = new ArrayList<>();
        if(layers.size() == 4) {
        ...
        for(int i = 0; i < pixels.size(); i++) {
            ...
            List<Double> calculations3 = new ArrayList<>();
            if(layers.size() == 4) {
                calculations3 = layers.get(0).calculate(null, false);
            }
            List<Double> dcdathing = new ArrayList<>();
            List<List<Double>> nextdcda = new ArrayList<>();
            ...
            nextdcda = new ArrayList<>();
            for(int j = 0; j < calculations1.size(); j++) {
                if(dw1.size() <= j) {
                    dw1.add(new ArrayList<>());
                }
    ...
    public static void main(String[] args) throws IOException {
        ...
        line = br.readLine();
        List<List<Integer>> pixelss = new ArrayList<>();
        while(line != null) {
        ...
        line = br.readLine();
        line = br.readLine();
        List<List<Integer>> tpixelss = new ArrayList<>();
        while(line != null) {
            String[] tokens = line.split(",");
            List<Integer> pixels = new ArrayList<>();
            pixels.add(Integer.parseInt(tokens[0]));
        ...
        double correct = 0;
        Queue<Double> last = new LinkedList<>();
        last.offer(0.0);
